...
router.delete('/deleteteachercamp/:id/:campName',CampController.RemoveTeacherFromCamp)

router.delete('/deletestudentcamp/:id/:campName',CampController.RemoveStudentFromCamp)
